...
export const webRoutes = [
  ...
  { method: "POST", path: "/category/{categoryId}/place/{id}/addreview", config: placeController.addReview },
  ...
  { method: "GET", path: "/category/{categoryId}/place/{id}/editreview/{reviewId}", config: placeController.editReview },
  { method: "POST", path: "/category/{categoryId}/place/{id}/editreview/{reviewId}", config: placeController.replaceReview },
  { method: "GET", path: "/category/{categoryId}/place/{id}/deletereview/{reviewId}", config: placeController.deleteReview },
